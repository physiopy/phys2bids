...
integration:
	@pip install -e ".[test]"
	@pytest --log-cli-level=INFO --cov-append --cov-report term-missing --cov=phys2bids --junitxml=/tmp/cirrus-ci-build/coverage.xml -k test_integration phys2bids/tests/test_integration.
