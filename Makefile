...
integration:
	@pip install -e ".[test]"
	@pytest --log-cli-level=INFO --cov-append --cov-report=xml:/tmp/cirrus-ci-build/shared/coverage/coverage_integration_37.xml --cov=phys2bids -k test_integration phys2bids/tests/test_integration.py
