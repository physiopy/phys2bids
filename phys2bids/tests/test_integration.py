...
#     # Check that files are generated
#     assert os.path.isfile(os.path.join(test_path, 'Test_belt_pulse_multifreq.log'))
#     assert os.path.isfile(os.path.join(test_path, 'Test_belt_pulse_multifreq.json'))
#     assert os.path.isfile(os.path.join(test_path, 'Test_belt_pulse_multifreq.tsv.gz'))
#     assert os.path.isfile(os.path.join(test_path, 'Test_belt_pulse_multifreq_trigger_time.png'))

#     # Read log file (note that this file is not the logger file)
#     with open(os.path.join(test_path, 'Test_belt_pulse_multifreq.log')) as log_info:
#         log_info = log_info.readlines()
...
# # Checks json file
#     # json_data = json.load(os.path.join(test_path, 'tutorial_file.json'))
#     with open(os.path.join(test_path, 'Test_belt_pulse_multifreq.json')) as json_file:
#         json_data = json.load(json_file)
