...
def _get_parser():
    ...
    required.add_argument(
        ...
        type=str,
        help=(
            "The name of the file containing physiological "
    ...
    optional.add_argument(
        ...
        type=str,
        help=(
            "File containing heuristic, with or without "
    ...
    optional.add_argument(
        ...
        type=int,
        help=(
            "The column number of the trigger channel. "
    ...
    optional.add_argument(
        ...
        type=int,
        help=(
            "The column numbers of  the channels to process. "
    ...
    optional.add_argument(
        ...
        type=int,
        help=(
            "Number of expected trigger timepoints (TRs). "
    ...
    optional.add_argument(
        ...
        type=float,
        help=(
            "Padding in seconds used around a single run "
...
if __name__ == "__main__":
    raise RuntimeError(
        ...
        "Please `pip install` phys2bids and use the `phys2bids` command"
    )
